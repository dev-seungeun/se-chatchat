...
import { getDatabase, ref, set, get, child, update, remove, onChildAdded, onChildChanged, onValue, query, limitToLast } from "firebase/database";
...
export const database_get = get;
export const database_child = child;
export const database_update = update;
export const database_remove = remove;
